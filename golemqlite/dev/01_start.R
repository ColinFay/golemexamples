...
golem::fill_desc(
  pkg_name = "golemqlite", # The Name of the package containing the App 
  pkg_title = "golemqlite", # The Title of the package containing the App 
  pkg_description = "Example of golem & sqlite..", # The Description of the package containing the App 
