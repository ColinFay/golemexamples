...
`get_golem_config()` will look for the value based on the `GOLEM_CONFIG_ACTIVE` parameter (or also `RCONFIG_ACTIVE` in some old versions of `{golem}`, check `R/app_config.R` for supported env var).
