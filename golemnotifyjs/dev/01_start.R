...
golem::fill_desc(
  pkg_name = "notifyjsexample", # The Name of the package containing the App 
  pkg_title = "Notifyjs in Shiny Example", # The Title of the package containing the App 
  pkg_description = "Notifyjs in Shiny Example.", # The Description of the package containing the App 
